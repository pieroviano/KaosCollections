...
#region Test methods (LINQ emulation)
        ...
        public void UnitRmq_Skip()
        {
            ...
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1, p2 }, rm.Skip(-1)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1, p2 }, rm.Skip(0)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2 }, rm.Skip(1)));
            Assert.Equal(0, SLE.Count(rm.Skip(0).Skip(2)));
            Assert.Equal(0, SLE.Count(rm.Skip(0).Skip(3)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1, p2 }, rm.Skip(0).Skip(-1)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1, p2 }, rm.Skip(0).Skip(0)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2 }, rm.Skip(0).Skip(1)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2 }, rm.Skip(1).Skip(-1)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2 }, rm.Skip(1).Skip(0)));
            Assert.Equal(0, SLE.Count(rm.Skip(2).Skip(0)));
            Assert.Equal(0, SLE.Count(rm.Skip(2).Skip(1)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2, p1 }, rm.Reverse().Skip(-1)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2, p1 }, rm.Reverse().Skip(0)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1 }, rm.Reverse().Skip(1)));
        ...
        public void UnitRmq_SkipWhile2Ctor()
        {
            ...
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1, p2 }, rm.SkipWhile(x => false)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2 }, rm.SkipWhile(x => x.Key % 2 != 0)));
            Assert.Equal(0, SLE.Count(rm.SkipWhile(x => true)));
        }
        ...
        public void UnitRmq_SkipWhile2F()
        {
            ...
            rm.Add(p1.Key, p1.Value);
            Assert.Equal(0, SLE.Count(rm.Skip(0).SkipWhile(x => true)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1 }, rm.Skip(0).SkipWhile(x => false)));
            rm.Add(p2.Key, p2.Value);
            rm.Add(p3.Key, p3.Value);
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2, p3 }, rm.Skip(0).SkipWhile(kv => kv.Key % 2 != 0)));
        }
        ...
        public void UnitRmq_SkipWhile2R()
        {
            ...
            rm.Add(p1.Key, p1.Value);
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1 }, rm.Reverse().SkipWhile(x => false)));
            Assert.Equal(0, SLE.Count(rm.Reverse().SkipWhile(x => true)));
            rm.Add(p2.Key, p2.Value);
            rm.Add(p3.Key, p3.Value);
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2, p1 }, rm.Reverse().SkipWhile(x => x.Key % 2 != 0)));
        }
        ...
        public void UnitRmq_SkipWhile3Ctor()
        {
            ...
            rm.Add(p1.Key, p1.Value);
            rm.Add(p2.Key, p2.Value);
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1, p2 }, rm.SkipWhile((p, i) => false)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2 }, rm.SkipWhile((p, i) => p.Key % 2 != 0)));
            Assert.Equal(0, SLE.Count(rm.SkipWhile((p, i) => true)));
        }
        ...
        public void UnitRmq_SkipWhile3F()
        {
            ...
            rm.Add(p1.Key, p1.Value);
            Assert.Equal(0, SLE.Count(rm.Skip(0).SkipWhile((p, i) => true)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1 }, rm.Skip(0).SkipWhile((p, i) => false)));
            rm.Add(p2.Key, p2.Value);
            rm.Add(p3.Key, p3.Value);
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p3 }, rm.Skip(0).SkipWhile((p, i) => p.Key % 2 == 0 || i < 1)));
            Assert.Equal(0, SLE.Count(rm.Skip(0).SkipWhile((p, i) => true)));
        }
        ...
        public void UnitRmq_SkipWhile3R()
        {
            ...
            rm.Add(p1.Key, p1.Value);
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1 }, rm.Reverse().SkipWhile((p, i) => false)));
            Assert.Equal(0, SLE.Count(rm.Reverse().SkipWhile((p, i) => true)));
            rm.Add(p2.Key, p2.Value);
            rm.Add(p3.Key, p3.Value);
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1 }, rm.Reverse().SkipWhile((p, i) => p.Key % 2 == 0 || i < 1)));
            Assert.Equal(0, SLE.Count(rm.Reverse().SkipWhile((p, i) => true)));
        }
...
#region Test Keys methods (LINQ emulation)
        ...
        public void UnitRmkq_Skip()
        {
            ...
            rm.Add(1, -1);
            rm.Add(2, -2);
            Assert.True(SLE.SequenceEqual(new int[] { 1, 2 }, rm.Keys.Skip(-1)));
            Assert.True(SLE.SequenceEqual(new int[] { 1, 2 }, rm.Keys.Skip(0)));
            Assert.True(SLE.SequenceEqual(new int[] { 2 }, rm.Keys.Skip(1)));
            Assert.Equal(0, SLE.Count(rm.Keys.Skip(2)));
            Assert.Equal(0, SLE.Count(rm.Keys.Skip(3)));
            Assert.True(SLE.SequenceEqual(new int[] { 1, 2 }, rm.Keys.Skip(0).Skip(-1)));
            Assert.True(SLE.SequenceEqual(new int[] { 1, 2 }, rm.Keys.Skip(0).Skip(0)));
            Assert.True(SLE.SequenceEqual(new int[] { 2 }, rm.Keys.Skip(0).Skip(1)));
            Assert.Equal(0, SLE.Count(rm.Skip(0).Skip(3)));
            Assert.True(SLE.SequenceEqual(new int[] { 2, 1 }, rm.Keys.Reverse().Skip(-1)));
            Assert.True(SLE.SequenceEqual(new int[] { 2, 1 }, rm.Keys.Reverse().Skip(0)));
            Assert.True(SLE.SequenceEqual(new int[] { 1 }, rm.Keys.Reverse().Skip(1)));
        ...
        public void UnitRmkq_SkipWhile2Ctor()
        {
            ...
            rm.Add(1, -1);
            rm.Add(2, -2);
            Assert.True(SLE.SequenceEqual(new int[] { 1, 2 }, rm.Keys.SkipWhile(x => false)));
            Assert.Equal(0, SLE.Count(rm.Keys.SkipWhile(x => true)));
            rm.Add(3, -3);
            Assert.True(SLE.SequenceEqual(new int[] { 2, 3 }, rm.Keys.SkipWhile(x => x % 2 != 0)));
        }
        ...
        public void UnitRmkq_SkipWhile2F()
        {
            ...
            rm.Add(1, -1);
            Assert.Equal(0, SLE.Count(rm.Keys.Skip(0).SkipWhile(x => true)));
            Assert.True(SLE.SequenceEqual(new int[] { 1 }, rm.Keys.Skip(0).SkipWhile(x => false)));
            rm.Add(2, -2);
            rm.Add(3, -3);
            Assert.True(SLE.SequenceEqual(new int[] { 2, 3 }, rm.Keys.Skip(0).SkipWhile(x => x % 2 != 0)));
        }
        ...
        public void UnitRmkq_SkipWhile2R()
        {
            ...
            rm.Add(1, -1);
            Assert.Equal(0, SLE.Count(rm.Keys.Reverse().SkipWhile(x => true)));
            Assert.True(SLE.SequenceEqual(new int[] { 1 }, rm.Keys.Reverse().SkipWhile(x => false)));
            rm.Add(2, -2);
            rm.Add(3, -3);
            Assert.True(SLE.SequenceEqual(new int[] { 2, 1 }, rm.Keys.Reverse().SkipWhile(x => x % 2 != 0)));
        }
        ...
        public void UnitRmkq_SkipWhile3Ctor()
        {
            ...
            rm.Add(1, -1);
            rm.Add(2, -2);
            Assert.True(SLE.SequenceEqual(new int[] { 1, 2 }, rm.Keys.SkipWhile((k, i) => false)));
            Assert.Equal(0, SLE.Count(rm.Keys.SkipWhile((k, i) => true)));
            rm.Add(3, -3);
            rm.Add(4, -4);
            rm.Add(5, -5);
            Assert.True(SLE.SequenceEqual(new int[] { 4, 5 }, rm.Keys.SkipWhile((k, i) => i < 2 || k % 2 != 0)));
        }
        ...
        public void UnitRmkq_SkipWhile3F()
        {
            ...
            rm.Add(2, -2);
            Assert.Equal(0, SLE.Count(rm.Keys.Skip(0).SkipWhile((k, i) => true)));
            Assert.True(SLE.SequenceEqual(new int[] { 1, 2 }, rm.Keys.Skip(0).SkipWhile((k, i) => false)));
            rm.Add(3, -3);
            rm.Add(4, -4);
            Assert.True(SLE.SequenceEqual(new int[] { 3, 4 }, rm.Keys.Skip(0).SkipWhile((k, i) => i < 1 || k % 2 == 0)));
        }
        ...
        public void UnitRmkq_SkipWhile3R()
        {
            ...
            rm.Add(2, -2);
            Assert.Equal(0, SLE.Count(rm.Keys.Reverse().SkipWhile((k, i) => true)));
            Assert.True(SLE.SequenceEqual(new int[] { 2, 1 }, rm.Keys.Reverse().SkipWhile((k, i) => false)));
            rm.Add(3, -3);
            rm.Add(4, -4);
            Assert.True(SLE.SequenceEqual(new int[] { 2, 1 }, rm.Keys.Reverse().SkipWhile((k, i) => i < 1 || k % 2 != 0)));
        }
...
#region Test Values methods (LINQ emulation)
        ...
        public void UnitRmvq_Skip()
        {
            ...
            rm.Add(1, 11);
            rm.Add(2, 22);
            Assert.True(SLE.SequenceEqual(new int[] { 11, 22 }, rm.Values.Skip(-1)));
            Assert.True(SLE.SequenceEqual(new int[] { 11, 22 }, rm.Values.Skip(0)));
            Assert.True(SLE.SequenceEqual(new int[] { 22 }, rm.Values.Skip(1)));
            Assert.Equal(0, SLE.Count(rm.Values.Skip(0).Skip(2)));
            Assert.Equal(0, SLE.Count(rm.Values.Skip(0).Skip(3)));
            Assert.True(SLE.SequenceEqual(new int[] { 11, 22 }, rm.Values.Skip(0).Skip(-1)));
            Assert.True(SLE.SequenceEqual(new int[] { 11, 22 }, rm.Values.Skip(0).Skip(0)));
            Assert.True(SLE.SequenceEqual(new int[] { 22 }, rm.Values.Skip(0).Skip(1)));
            Assert.True(SLE.SequenceEqual(new int[] { 22 }, rm.Values.Skip(1).Skip(-1)));
            Assert.True(SLE.SequenceEqual(new int[] { 22 }, rm.Values.Skip(1).Skip(0)));
            Assert.Equal(0, SLE.Count(rm.Values.Skip(2).Skip(0)));
            Assert.Equal(0, SLE.Count(rm.Values.Skip(2).Skip(1)));
            Assert.True(SLE.SequenceEqual(new int[] { 22, 11 }, rm.Values.Reverse().Skip(-1)));
            Assert.True(SLE.SequenceEqual(new int[] { 22, 11 }, rm.Values.Reverse().Skip(0)));
            Assert.True(SLE.SequenceEqual(new int[] { 11 }, rm.Values.Reverse().Skip(1)));
        ...
        public void UnitRmvq_SkipWhile2Ctor()
        {
            ...
            rm.Add(1, -1);
            rm.Add(2, -2);
            Assert.True(SLE.SequenceEqual(new int[] { -1, -2 }, rm.Values.SkipWhile(x => false)));
            Assert.Equal(0, SLE.Count(rm.Values.SkipWhile(x => true)));
            rm.Add(3, -3);
            Assert.True(SLE.SequenceEqual(new int[] { -2, -3 }, rm.Values.SkipWhile(x => x % 2 != 0)));
        }
        ...
        public void UnitRmvq_SkipWhile2F()
        {
            ...
            rm.Add(1, -1);
            Assert.Equal(0, SLE.Count(rm.Values.Skip(0).SkipWhile(x => true)));
            Assert.True(SLE.SequenceEqual(new int[] { -1 }, rm.Values.Skip(0).SkipWhile(x => false)));
            rm.Add(2, -2);
            rm.Add(3, -3);
            Assert.True(SLE.SequenceEqual(new int[] { -2, -3 }, rm.Values.Skip(0).SkipWhile(x => x % 2 != 0)));
        }
        ...
        public void UnitRmvq_SkipWhile2R()
        {
            ...
            rm.Add(1, -1);
            Assert.Equal(0, SLE.Count(rm.Values.Reverse().SkipWhile(x => true)));
            Assert.True(SLE.SequenceEqual(new int[] { -1 }, rm.Values.Reverse().SkipWhile(x => false)));
            rm.Add(2, -2);
            rm.Add(3, -3);
            Assert.True(SLE.SequenceEqual(new int[] { -2, -1 }, rm.Values.Reverse().SkipWhile(x => x % 2 != 0)));
        }
        ...
        public void UnitRmvq_SkipWhile3Ctor()
        {
            ...
            rm.Add(1, -1);
            rm.Add(2, -2);
            Assert.True(SLE.SequenceEqual(new int[] { -1, -2 }, rm.Values.SkipWhile((v, i) => false)));
            Assert.Equal(0, SLE.Count(rm.Values.SkipWhile((v, i) => true)));
            rm.Add(3, -3);
            rm.Add(4, -4);
            rm.Add(5, -5);
            Assert.True(SLE.SequenceEqual(new int[] { -4, -5 }, rm.Values.SkipWhile((v, i) => v > -3 || i % 2 == 0)));
        }
        ...
        public void UnitRmvq_SkipWhile3F()
        {
            ...
            rm.Add(2, -2);
            Assert.Equal(0, SLE.Count(rm.Values.Skip(0).SkipWhile((v, i) => true)));
            Assert.True(SLE.SequenceEqual(new int[] { -1, -2 }, rm.Values.Skip(0).SkipWhile((v, i) => false)));
            rm.Add(3, -3);
            rm.Add(4, -4);
            Assert.True(SLE.SequenceEqual(new int[] { -3, -4 }, rm.Values.Skip(0).SkipWhile((v, i) => v > -2 || i % 2 != 0)));
        }
        ...
        public void UnitRmvq_SkipWhile3R()
        {
            ...
            rm.Add(2, -2);
            Assert.Equal(0, SLE.Count(rm.Values.Reverse().SkipWhile((v, i) => true)));
            Assert.True(SLE.SequenceEqual(new int[] { -2, -1 }, rm.Values.Reverse().SkipWhile((v, i) => false)));
            rm.Add(3, -3);
            rm.Add(4, -4);
            Assert.True(SLE.SequenceEqual(new int[] { -2, -1 }, rm.Values.Reverse().SkipWhile((v, i) => v < -3 || i % 2 != 0)));
        }
