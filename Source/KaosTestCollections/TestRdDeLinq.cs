...
namespace Kaos.Test.Collections
{
    public partial class TestRd : IClassFixture<BinaryFormatterEnableFixture>
    {
        ...
        public void UnitRdq_Skip()
        {
            ...
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1, p2 }, dary1.Skip(-1)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1, p2 }, dary1.Skip(0)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2 }, dary1.Skip(1)));
            Assert.Equal(0, SLE.Count(dary1.Skip(0).Skip(2)));
            Assert.Equal(0, SLE.Count(dary1.Skip(0).Skip(3)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1, p2 }, dary1.Skip(0).Skip(-1)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1, p2 }, dary1.Skip(0).Skip(0)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2 }, dary1.Skip(0).Skip(1)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2 }, dary1.Skip(1).Skip(-1)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2 }, dary1.Skip(1).Skip(0)));
            Assert.Equal(0, SLE.Count(dary1.Skip(2).Skip(0)));
            Assert.Equal(0, SLE.Count(dary1.Skip(2).Skip(1)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2, p1 }, dary1.Reverse().Skip(-1)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2, p1 }, dary1.Reverse().Skip(0)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1 }, dary1.Reverse().Skip(1)));
        ...
        public void UnitRdq_SkipWhile2Ctor()
        {
            ...
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1, p2 }, dary1.SkipWhile(x => false)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2 }, dary1.SkipWhile(x => x.Key % 2 != 0)));
            Assert.Equal(0, SLE.Count(dary1.SkipWhile(x => true)));
        }
        ...
        public void UnitRdq_SkipWhile2F()
        {
            ...
            dary1.Add(p1.Key, p1.Value);
            Assert.Equal(0, SLE.Count(dary1.Skip(0).SkipWhile(x => true)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1 }, dary1.Skip(0).SkipWhile(x => false)));
            dary1.Add(p2.Key, p2.Value);
            dary1.Add(p3.Key, p3.Value);
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2, p3 }, dary1.Skip(0).SkipWhile(kv => kv.Key % 2 != 0)));
        }
        ...
        public void UnitRdq_SkipWhile2R()
        {
            ...
            dary1.Add(p1.Key, p1.Value);
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1 }, dary1.Reverse().SkipWhile(x => false)));
            Assert.Equal(0, SLE.Count(dary1.Reverse().SkipWhile(x => true)));
            dary1.Add(p2.Key, p2.Value);
            dary1.Add(p3.Key, p3.Value);
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2, p1 }, dary1.Reverse().SkipWhile(x => x.Key % 2 != 0)));
        }
        ...
        public void UnitRdq_SkipWhile3Ctor()
        {
            ...
            dary1.Add(p1.Key, p1.Value);
            dary1.Add(p2.Key, p2.Value);
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1, p2 }, dary1.SkipWhile((p, i) => false)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p2 }, dary1.SkipWhile((p, i) => p.Key % 2 != 0)));
            Assert.Equal(0, SLE.Count(dary1.SkipWhile((p, i) => true)));
        }
        ...
        public void UnitRdq_SkipWhile3F()
        {
            ...
            dary1.Add(p1.Key, p1.Value);
            Assert.Equal(0, SLE.Count(dary1.Skip(0).SkipWhile((p, i) => true)));
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1 }, dary1.Skip(0).SkipWhile((p, i) => false)));
            dary1.Add(p2.Key, p2.Value);
            dary1.Add(p3.Key, p3.Value);
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p3 }, dary1.Skip(0).SkipWhile((p, i) => p.Key % 2 == 0 || i < 1)));
            Assert.Equal(0, SLE.Count(dary1.Skip(0).SkipWhile((p, i) => true)));
        }
        ...
        public void UnitRdq_SkipWhile3R()
        {
            ...
            dary1.Add(p1.Key, p1.Value);
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1 }, dary1.Reverse().SkipWhile((p, i) => false)));
            Assert.Equal(0, SLE.Count(dary1.Reverse().SkipWhile((p, i) => true)));
            dary1.Add(p2.Key, p2.Value);
            dary1.Add(p3.Key, p3.Value);
            Assert.True(SLE.SequenceEqual(new SCG.KeyValuePair<int, int>[] { p1 }, dary1.Reverse().SkipWhile((p, i) => p.Key % 2 == 0 || i < 1)));
            Assert.Equal(0, SLE.Count(dary1.Reverse().SkipWhile((p, i) => true)));
        }
        ...
        public void UnitRdkq_Skip()
        {
            ...
            dary1.Add(1, -1);
            dary1.Add(2, -2);
            Assert.True(SLE.SequenceEqual(new int[] { 1, 2 }, dary1.Keys.Skip(-1)));
            Assert.True(SLE.SequenceEqual(new int[] { 1, 2 }, dary1.Keys.Skip(0)));
            Assert.True(SLE.SequenceEqual(new int[] { 2 }, dary1.Keys.Skip(1)));
            Assert.Equal(0, SLE.Count(dary1.Keys.Skip(2)));
            Assert.Equal(0, SLE.Count(dary1.Keys.Skip(3)));
            Assert.True(SLE.SequenceEqual(new int[] { 1, 2 }, dary1.Keys.Skip(0).Skip(-1)));
            Assert.True(SLE.SequenceEqual(new int[] { 1, 2 }, dary1.Keys.Skip(0).Skip(0)));
            Assert.True(SLE.SequenceEqual(new int[] { 2 }, dary1.Keys.Skip(0).Skip(1)));
            Assert.Equal(0, SLE.Count(dary1.Skip(0).Skip(3)));
            Assert.True(SLE.SequenceEqual(new int[] { 2, 1 }, dary1.Keys.Reverse().Skip(-1)));
            Assert.True(SLE.SequenceEqual(new int[] { 2, 1 }, dary1.Keys.Reverse().Skip(0)));
            Assert.True(SLE.SequenceEqual(new int[] { 1 }, dary1.Keys.Reverse().Skip(1)));
        ...
        public void UnitRdkq_SkipWhile2Ctor()
        {
            ...
            dary1.Add(1, -1);
            dary1.Add(2, -2);
            Assert.True(SLE.SequenceEqual(new int[] { 1, 2 }, dary1.Keys.SkipWhile(x => false)));
            Assert.Equal(0, SLE.Count(dary1.Keys.SkipWhile(x => true)));
            dary1.Add(3, -3);
            Assert.True(SLE.SequenceEqual(new int[] { 2, 3 }, dary1.Keys.SkipWhile(x => x % 2 != 0)));
        }
        ...
        public void UnitRdkq_SkipWhile2F()
        {
            ...
            dary1.Add(1, -1);
            Assert.Equal(0, SLE.Count(dary1.Keys.Skip(0).SkipWhile(x => true)));
            Assert.True(SLE.SequenceEqual(new int[] { 1 }, dary1.Keys.Skip(0).SkipWhile(x => false)));
            dary1.Add(2, -2);
            dary1.Add(3, -3);
            Assert.True(SLE.SequenceEqual(new int[] { 2, 3 }, dary1.Keys.Skip(0).SkipWhile(x => x % 2 != 0)));
        }
        ...
        public void UnitRdkq_SkipWhile2R()
        {
            ...
            dary1.Add(1, -1);
            Assert.Equal(0, SLE.Count(dary1.Keys.Reverse().SkipWhile(x => true)));
            Assert.True(SLE.SequenceEqual(new int[] { 1 }, dary1.Keys.Reverse().SkipWhile(x => false)));
            dary1.Add(2, -2);
            dary1.Add(3, -3);
            Assert.True(SLE.SequenceEqual(new int[] { 2, 1 }, dary1.Keys.Reverse().SkipWhile(x => x % 2 != 0)));
        }
        ...
        public void UnitRdkq_SkipWhile3Ctor()
        {
            ...
            dary1.Add(1, -1);
            dary1.Add(2, -2);
            Assert.True(SLE.SequenceEqual(new int[] { 1, 2 }, dary1.Keys.SkipWhile((k, i) => false)));
            Assert.Equal(0, SLE.Count(dary1.Keys.SkipWhile((k, i) => true)));
            dary1.Add(3, -3);
            dary1.Add(4, -4);
            dary1.Add(5, -5);
            Assert.True(SLE.SequenceEqual(new int[] { 4, 5 }, dary1.Keys.SkipWhile((k, i) => i < 2 || k % 2 != 0)));
        }
        ...
        public void UnitRdkq_SkipWhile3F()
        {
            ...
            dary1.Add(2, -2);
            Assert.Equal(0, SLE.Count(dary1.Keys.Skip(0).SkipWhile((k, i) => true)));
            Assert.True(SLE.SequenceEqual(new int[] { 1, 2 }, dary1.Keys.Skip(0).SkipWhile((k, i) => false)));
            dary1.Add(3, -3);
            dary1.Add(4, -4);
            Assert.True(SLE.SequenceEqual(new int[] { 3, 4 }, dary1.Keys.Skip(0).SkipWhile((k, i) => i < 1 || k % 2 == 0)));
        }
        ...
        public void UnitRdkq_SkipWhile3R()
        {
            ...
            dary1.Add(2, -2);
            Assert.Equal(0, SLE.Count(dary1.Keys.Reverse().SkipWhile((k, i) => true)));
            Assert.True(SLE.SequenceEqual(new int[] { 2, 1 }, dary1.Keys.Reverse().SkipWhile((k, i) => false)));
            dary1.Add(3, -3);
            dary1.Add(4, -4);
            Assert.True(SLE.SequenceEqual(new int[] { 2, 1 }, dary1.Keys.Reverse().SkipWhile((k, i) => i < 1 || k % 2 != 0)));
        }
        ...
        public void UnitRdvq_Skip()
        {
            ...
            dary1.Add(1, 11);
            dary1.Add(2, 22);
            Assert.True(SLE.SequenceEqual(new int[] { 11, 22 }, dary1.Values.Skip(-1)));
            Assert.True(SLE.SequenceEqual(new int[] { 11, 22 }, dary1.Values.Skip(0)));
            Assert.True(SLE.SequenceEqual(new int[] { 22 }, dary1.Values.Skip(1)));
            Assert.Equal(0, SLE.Count(dary1.Values.Skip(0).Skip(2)));
            Assert.Equal(0, SLE.Count(dary1.Values.Skip(0).Skip(3)));
            Assert.True(SLE.SequenceEqual(new int[] { 11, 22 }, dary1.Values.Skip(0).Skip(-1)));
            Assert.True(SLE.SequenceEqual(new int[] { 11, 22 }, dary1.Values.Skip(0).Skip(0)));
            Assert.True(SLE.SequenceEqual(new int[] { 22 }, dary1.Values.Skip(0).Skip(1)));
            Assert.True(SLE.SequenceEqual(new int[] { 22 }, dary1.Values.Skip(1).Skip(-1)));
            Assert.True(SLE.SequenceEqual(new int[] { 22 }, dary1.Values.Skip(1).Skip(0)));
            Assert.Equal(0, SLE.Count(dary1.Values.Skip(2).Skip(0)));
            Assert.Equal(0, SLE.Count(dary1.Values.Skip(2).Skip(1)));
            Assert.True(SLE.SequenceEqual(new int[] { 22, 11 }, dary1.Values.Reverse().Skip(-1)));
            Assert.True(SLE.SequenceEqual(new int[] { 22, 11 }, dary1.Values.Reverse().Skip(0)));
            Assert.True(SLE.SequenceEqual(new int[] { 11 }, dary1.Values.Reverse().Skip(1)));
        ...
        public void UnitRdvq_SkipWhile2Ctor()
        {
            ...
            dary1.Add(1, -1);
            dary1.Add(2, -2);
            Assert.True(SLE.SequenceEqual(new int[] { -1, -2 }, dary1.Values.SkipWhile(x => false)));
            Assert.Equal(0, SLE.Count(dary1.Values.SkipWhile(x => true)));
            dary1.Add(3, -3);
            Assert.True(SLE.SequenceEqual(new int[] { -2, -3 }, dary1.Values.SkipWhile(x => x % 2 != 0)));
        }
        ...
        public void UnitRdvq_SkipWhile2F()
        {
            ...
            dary1.Add(1, -1);
            Assert.Equal(0, SLE.Count(dary1.Values.Skip(0).SkipWhile(x => true)));
            Assert.True(SLE.SequenceEqual(new int[] { -1 }, dary1.Values.Skip(0).SkipWhile(x => false)));
            dary1.Add(2, -2);
            dary1.Add(3, -3);
            Assert.True(SLE.SequenceEqual(new int[] { -2, -3 }, dary1.Values.Skip(0).SkipWhile(x => x % 2 != 0)));
        }
        ...
        public void UnitRdvq_SkipWhile2R()
        {
            ...
            dary1.Add(1, -1);
            Assert.Equal(0, SLE.Count(dary1.Values.Reverse().SkipWhile(x => true)));
            Assert.True(SLE.SequenceEqual(new int[] { -1 }, dary1.Values.Reverse().SkipWhile(x => false)));
            dary1.Add(2, -2);
            dary1.Add(3, -3);
            Assert.True(SLE.SequenceEqual(new int[] { -2, -1 }, dary1.Values.Reverse().SkipWhile(x => x % 2 != 0)));
        }
        ...
        public void UnitRdvq_SkipWhile3Ctor()
        {
            ...
            dary1.Add(1, -1);
            dary1.Add(2, -2);
            Assert.True(SLE.SequenceEqual(new int[] { -1, -2 }, dary1.Values.SkipWhile((v, i) => false)));
            Assert.Equal(0, SLE.Count(dary1.Values.SkipWhile((v, i) => true)));
            dary1.Add(3, -3);
            dary1.Add(4, -4);
            dary1.Add(5, -5);
            Assert.True(SLE.SequenceEqual(new int[] { -4, -5 }, dary1.Values.SkipWhile((v, i) => v > -3 || i % 2 == 0)));
        }
        ...
        public void UnitRdvq_SkipWhile3F()
        {
            ...
            dary1.Add(2, -2);
            Assert.Equal(0, SLE.Count(dary1.Values.Skip(0).SkipWhile((v, i) => true)));
            Assert.True(SLE.SequenceEqual(new int[] { -1, -2 }, dary1.Values.Skip(0).SkipWhile((v, i) => false)));
            dary1.Add(3, -3);
            dary1.Add(4, -4);
            Assert.True(SLE.SequenceEqual(new int[] { -3, -4 }, dary1.Values.Skip(0).SkipWhile((v, i) => v > -2 || i % 2 != 0)));
        }
        ...
        public void UnitRdvq_SkipWhile3R()
        {
            ...
            dary1.Add(2, -2);
            Assert.Equal(0, SLE.Count(dary1.Values.Reverse().SkipWhile((v, i) => true)));
            Assert.True(SLE.SequenceEqual(new int[] { -2, -1 }, dary1.Values.Reverse().SkipWhile((v, i) => false)));
            dary1.Add(3, -3);
            dary1.Add(4, -4);
            Assert.True(SLE.SequenceEqual(new int[] { -2, -1 }, dary1.Values.Reverse().SkipWhile((v, i) => v < -3 || i % 2 != 0)));
        }
