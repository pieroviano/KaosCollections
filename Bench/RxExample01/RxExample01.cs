...
class RxExample01
{
    static void Main()
    {
        ...
        foreach (var x in bag.Skip (100).SkipWhile (i => i%2==0).Skip (100))
            Console.Write ($"{x} ");
        ...
        for (var i = 2; i < 500; i += 2) set.Add (i);
        ...
        for (var i = 2; i < 500; i += 2) dary.Add (i,-i);
        ...
        for (var i = 2; i < 500; i += 2) daryk.Add (i,-i);
        ...
        for (var i = 2; i < 500; i += 2) daryv.Add (i,-i);
        ...
        for (var i = 2; i < 500; i += 2) map.Add (i,-i);
        ...
        for (var i = 2; i < 500; i += 2) mapk.Add (i,-i);
        ...
        for (var i = 2; i < 500; i += 2) mapv.Add (i,-i);
